document.addEventListener('DOMContentLoaded', () => {
    ...
    fetch('humanidades.json')
        .then(response => {
            if (!response.ok) {
                throw new Error("No se pudo cargar el archivo de libros de humanidades");
            }
...
// Función con la configuración de Swiper corregida
